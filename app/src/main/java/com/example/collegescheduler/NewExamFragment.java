...
public class NewExamFragment extends Fragment {
     ...
     * @return A new instance of fragment NewExamFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.ExamSubmitButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(NewExamFragment.this)
                        .navigate(R.id.NewExamFragmentToMenuFragment);
            }
        });
    }
}